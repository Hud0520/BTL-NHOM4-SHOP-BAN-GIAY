...
namespace BTL_ASP.Areas.Admin.Controllers
{
    public class TheLoaisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaDanhMuc,MoTa,NgayTao,NgaySua,TenTheLoai")] TheLoai theLoai)
        {
        ...
        [HttpPost, ValidateInput(false)]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDanhMuc,MoTa,NgayTao,NgaySua,TenTheLoai")] TheLoai theLoai)
        {
            if (ModelState.IsValid)
            {
